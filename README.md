...
監視ツールで障害を検知した場合にBaristaをコールすることでオペレーションエンジニアに確実に障害を伝えることができ、またその履歴を取得できるので、誰が対応しているのか、各人の回答は何だったのかを得ることができます。    

* 一斉に架電する機能（全員から回答があるまで未回答の人に架電を繰り返す）
* 順番に架電する機能（誰か一人から回答があるまで繰り返す）
* 履歴を取得する機能

架電処理自体はtwilioを使って実現させています。Baristaはtwilioを使って
